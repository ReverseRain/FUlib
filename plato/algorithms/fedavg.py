...
class Algorithm(base.Algorithm):
    ...
    def update_weights(self, deltas):
        ...
        print(f"Type of baseline_weights in _process_reports: {type(baseline_weights)}")  # 这里应该是 dict
        #assert isinstance(baseline_weights, dict), "baseline_weights 必须是 dict！"
    ...
    def load_weights(self, weights):
        ...
        print(f"Type of weights in load_weights: {type(weights)}")
