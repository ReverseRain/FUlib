...
alpha = 0.8  # for Dirichlet distribution. 100 for exdir
...
def save_file(config_path, train_path, test_path, train_data, test_data, num_clients,
              num_classes, statistic, proxy_path, proxy_data, niid=False, balance=True, partition=None):
    config = {
...
def sample_proxy(X, size=0.1):
    sample_size = int(len(X) * 0.1)
